          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li class="<?php echo $this->uri->segment(1) == 'DataTraining' ? 'active' : ''; ?>"><a class="nav-link" href="<?php echo base_url(); ?>DataTraining">Data Training</a></li>
            ...
            <li class="<?php echo $this->uri->segment(2) == 'credits' ? 'active' : ''; ?>"><a class="nav-link" href="<?php echo base_url(); ?>login/logout"><i class="fas fa-pencil-ruler"></i> <span>LogOut</span></a></li>
          </ul>
          <ul class="sidebar-menu">
